...
const OutRecordManagement = () => {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      message.error(editingRecord ? '出库记录更新失败' : '出库记录创建失败');
      console.error('操作出库记录失败:', error);
    }
  };
  ...
  return (
    <div>
      ...
      {/* 添加/编辑出库记录模态框 */}
      <Modal
        title={editingRecord ? '编辑出库记录' : '添加出库记录'}
        open={open}
...
export default OutRecordManagement;
